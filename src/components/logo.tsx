...
export function Logo() {
  return (
    <Link
      href="/"
      className="group isolate inline-flex min-w-0 items-center gap-3 border border-white/10 bg-black px-3 py-2 shadow-[0_0_22px_rgba(255,255,255,.14)] transition hover:border-white/20"
