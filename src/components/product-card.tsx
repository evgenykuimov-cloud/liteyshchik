  ...
  return (
    <article className="group border border-[var(--border)] bg-[var(--surface)]">
      ...
      <div className="p-5">
        ...
        <dl className="mt-4 grid gap-2 text-xs text-[var(--foreground-muted)]">
          <div>
        ...
        <Link href={href} className="mt-5 flex items-center justify-between border-t border-[var(--border)] pt-4 text-xs font-bold uppercase">
